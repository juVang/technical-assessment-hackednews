...
- after installing npm , open 2 taps in the termenal :

* on for the server type "npm start" in the termenal
  -the other for the webpack type "npm run dev-react" in the termenal ,
  then open the app on chrom using this link"http://localhost:8000/"
